...
public:
    ...
    SelectQuery(SelectorGenerators selector_gens, Tables tables);
...
private:
    ...
    static CanBeValidated<void>::TypeOrError is_valid(const SelectorGenerators& , const Tables& );
    static CanBeValidated<void>::TypeOrError check_all_tables_specified(const SelectorGenerators& , const Tables& );
    static CanBeValidated<void>::TypeOrError check_no_same_tables(const Tables& );
    static CanBeValidated<void>::TypeOrError check_if_from_exists_when_required(const SelectorGenerators& , const Tables& );
