...
TEST(test_cell_int_value, initialization) {
    ...
    sptr<CellComparable> amax = std::make_shared<CellIntValue>(std::numeric_limits<IntType>::max());
    sptr<CellComparable> amin = std::make_shared<CellIntValue>(std::numeric_limits<IntType>::min());
}
...
TEST(test_cell_int_value, basicComparingRange10) {
    sptr<CellComparable> a4 = std::make_shared<CellIntValue>(4);
    sptr<CellComparable> a0 = std::make_shared<CellIntValue>(0);
    sptr<CellComparable> a5 = std::make_shared<CellIntValue>(5);
    sptr<CellComparable> an7 = std::make_shared<CellIntValue>(-7);
